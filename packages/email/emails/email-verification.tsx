...
export const EmailVerificationEmail = ({
  ...
  <EmailLayout
    ...
    appUrl={appUrl}
  >
    <Text className="mt-7 mb-0 font-bold text-3xl text-[#1d1c1d]">{m.email_verification_heading({}, loc(locale))}</Text>
    <Text className="mt-8 mb-6 text-black text-lg leading-7">{m.email_verification_body({}, loc(locale))}</Text>
    <Button
    ...
    <Text className="mt-5 mb-0 text-[#444] text-sm">{m.email_verification_disclaimer({}, loc(locale))}</Text>
  </EmailLayout>
);
